...
import com.attach.springboot.attach.common.redis.RedisUtil;
...
public class TokenVerificationAspect {
   ...
   // private final RestTemplate restTemplate;
    ...
    public TokenVerificationAspect( RedisUtil redisUtil) {
      //  this.restTemplate = restTemplate;
        this.redisUtil = redisUtil;
        this.logger = LoggerFactory.getLogger(this.getClass());
    }

    @Pointcut("execution(public * com.attach.springboot.attach.bz1.controller..*.*(..))")
