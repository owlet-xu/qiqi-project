...
import com.attach.springboot.attach.common.citysafety.HttpRestException;
import com.attach.springboot.attach.common.citysafety.LimitIPRequestAnnotation;
...
public class LimitIPRequestAspect {
     ...
     */
    @Before("execution(* com.attach.springboot.attach.bz1.controller.*.*(..)) && @annotation(com.attach.springboot.attach.common.citysafety.LimitIPRequestAnnotation)")
